...
import com.wanglei.cameralibrary.camera.Camera2;
import com.wanglei.cameralibrary.camera.Camera2Api23;
...
//        }
    ...
    //当View附加到窗体时，也就是View和Window绑定时就会调用这个函数，
    // 此时将会有一个Surface进行绘图之类的逻辑。
    @Override
